...
public:
   ...
   int compileShaders(const char *vs, const char *fs, const char *gs=NULL) { // gs = geometry shader
...
private:
   ...
   GLuint vaoId, vboId, eboId, pId; // it's sufficient they are just initialized, rest is happening in functions
